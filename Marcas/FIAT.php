...
<?php require "../PHP/marcas.php";
    ...
    <div class="slideshow-container">
        ...
        <div id="radio1" class="mySlides fade">
          <img src="../imgLogosECarros/Fiat/FiatLogo.png" style="width:auto; height:400px;">
        </div>
        
        <div id="radio2" class="mySlides fade">
          <img src="../imgLogosECarros/Fiat/carro1.png" style="width:auto; height: 400px;;">
        </div>
        
        <div id="radio3" class="mySlides fade">
          <img src="../imgLogosECarros/Fiat/carro2.png" style="width:auto; height: 400px;;">
        </div>
        
        <div id="radio4" class="mySlides fade">
          <img src="../imgLogosECarros/Fiat/carro3.png" style="width:auto; height: 400px;;">
        </div>
        ...
        <?php
  $caraudi = "SELECT * FROM carros WHERE car_marca like 'Fiat'";
