...
<?php require "../PHP/marcas.php";
    ...
    <div class="slideshow-container">
        ...
        <div id="radio1" class="mySlides fade">
          <img src="../imgLogosECarros/Ferrari/Logo-Ferrari.png" style="width:auto; height:400px;">
        </div>
        
        <div id="radio2" class="mySlides fade">
          <img src="../imgLogosECarros/Ferrari/carro1.png" style="width:auto; height: 400px;">
        </div>
        
        <div id="radio3" class="mySlides fade">
          <img src="../imgLogosECarros/Ferrari/carro2.png" style="width:auto; height: 400px;">
        </div>
        
        <div id="radio4" class="mySlides fade">
          <img src="../imgLogosECarros/Ferrari/carro3.png" style="width:auto; height: 400px;">
        </div>
        ...
        <?php
  $caraudi = "SELECT * FROM carros WHERE car_marca like 'Ferrari'";
