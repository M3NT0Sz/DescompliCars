...
<?php require "../PHP/marcas.php";
    ...
    <div class="slideshow-container">
        ...
        <div id="radio1" class="mySlides fade">
          <img src="../imgLogosECarros/Volvo/VolvoLogo.png" style="width:auto; height:400px;">
        </div>
        
        <div id="radio2" class="mySlides fade">
          <img src="../imgLogosECarros/Volvo/carro1.png" style="width:auto; height: 400px;;">
        </div>
        
        <div id="radio3" class="mySlides fade">
          <img src="../imgLogosECarros/Volvo/carro2.png" style="width:auto; height: 400px;;">
        </div>
        
        <div id="radio4" class="mySlides fade">
          <img src="../imgLogosECarros/Volvo/carro3.png" style="width:auto; height: 400px;;">
        </div>
        ...
        <?php
  $caraudi = "SELECT * FROM carros WHERE car_marca like 'Volvo'";
