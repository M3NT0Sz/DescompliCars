<?php
        ...
        $_SESSION['rodape'] = "<div class=rodaPg>
            <div class=sec> 
                <h1> Endereço / Loja fisica </h1><br>
                Brasil <br>
                Rio Grande Do Sul <br>
                Porto Alegre <br>
                Rua Clemente Pereira <br>
                Sao Jose, 271
            </div>
            <div class=sec> 
                <h1> Telefone </h1><br>
            ...
            <div class=sec> 
                <h1> Contatos </h1><br>
                <i class=bx bxl-twitter> <font family=Poppins, sans-serif> @DescompliCars_Oficial  </font></i>
