...
foreach (filter_input(INPUT_POST, 'a', FILTER_SANITIZE_STRING) as $batata) {
    $sql = "UPDATE carros SET car_marca = '$marca', car_modelo = '$modelo', car_anomod = '$anoMod', car_anofab = '$anoFab', car_versao = '$versao', car_tipo = '$tipo', car_outros = '$batata' WHERE car_cod='$cod'";
