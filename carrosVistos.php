...
<body>
    ...
    <div class="lados">
        ...
        <div style="display:flex;justify-content:center;align-itens:center;text-align:center;flex-direction:column;width:100%;margin-top:20px;">
            <font color="#004aad"><h1>Carros Vistos</h1></font>
            <hr>
                <?php
